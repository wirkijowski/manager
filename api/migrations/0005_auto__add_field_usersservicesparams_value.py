...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UsersServicesParams.value'
        db.add_column(u'api_usersservicesparams', 'value',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UsersServicesParams.value'
        db.delete_column(u'api_usersservicesparams', 'value')
    ...
    models = {
        ...
        u'api.usersservicedomains': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'users_service': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_domains'", 'to': u"orm['api.UsersServices']"})
        },
        ...
        u'api.usersservicesparams': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'services_param': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "''", 'to': u"orm['api.ServiceParams']"}),
            'users_service': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_services_params'", 'to': u"orm['api.UsersServices']"}),
